            ...
            <li className="channels-list-content clearfix full-width">
                                ...
                                <div className="clearfix full-width">
                                    ...
                                    <p className="margin-right">
                                        ...
                                        <div className="channel-img img-cover" style={{backgroundImage: "url(../../../assets/img/channel-img.png)"}} onClick={()=>{hashHistory.push('/home/category/edit') }}>

                                        </div>
                                        <div className="margin-left">
                                            <a className="link-title"onClick={()=>{hashHistory.push('/home/category/edit') }}>NYC in the street 360</a>

                                            <p><span>7 videos</span></p>
                                             <DropdownButton title="Edit" id="bg-nested-dropdown" className="edit-select" style={{marginTop:"6px"}}>
                                                <MenuItem eventKey="1" onClick={()=>{hashHistory.push('/home/category/edit') }}>Edit</MenuItem>
