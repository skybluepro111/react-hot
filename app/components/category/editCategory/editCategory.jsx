                ...
                <div className="container">
                     <div className="chnnl">
                        ...
                        <ul className="channel-tt heading">
                            ...
                            <li className="bold"> Edit Category</li>
                        </ul>
                                ...
                                <form>
                                    ...
                                    <div className="padding-bottom">
                                       <ControlLabel  className="lbl">Description</ControlLabel>
                                        <FormControl inputRef={(ref) => {this.description = ref}} componentClass="textarea" rows="5" placeholder="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Utenim ad minim veniam" onChange={() => {}}/>
                                    </div>
